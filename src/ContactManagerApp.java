...
public class ContactManagerApp extends JFrame {
	...
	public static void main(String[] args) {
		...
		try{javax.swing.UIManager.setLookAndFeel("com.jtattoo.plaf.noire.NoireLookAndFeel");}
		catch (Exception e) {
		e.printStackTrace();
		}
...
//		setBounds(100, 100, 573, 417);
		...
		btnAddContact.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		panel.add(btnUpdateContact);
	
		//panel_1.add(btnUpdateContact);
		
		JButton btnDeleteRow = new JButton("Delete Contact");
		btnDeleteRow.setHorizontalAlignment(SwingConstants.LEFT);
...
//		JButton btnAddphn = new JButton("Add New Phone");
//		btnAddphn.setHorizontalAlignment(SwingConstants.LEFT);
//		panel_1.add(btnAddContact);
//		btnAddphn.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent e) {
//				
//				Addphn dialog = new Addphn(ContactManagerApp.this,contactDAO);
//				dialog.setVisible(true);
//				
//			}
//		});
